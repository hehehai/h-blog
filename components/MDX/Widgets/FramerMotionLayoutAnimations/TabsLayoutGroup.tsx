...
const TabsSharedLayoutAnimation = () => {
  ...
  return (
    <div
      className="flex items-center justify-center bg-[#1A1D23] border border-[#2B303B] rounded-lg gap-8 px-4 py-2"
...
const TabsLayoutGroup = (props: { layoutGroup: boolean }) => {
  ...
  return (
    <Card>
      <div className="flex flex-col space-y-4 py-10 max-w-[380px] items-center mx-auto">
        {layoutGroup ? (
          <>
            <LayoutGroup id="tab1">
