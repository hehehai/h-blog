...
![Vercel limit 50M](/static/images/vercel-deploy-headless/20240116092144.png)

好吧，出问题了! 于是我找到了这个 https://github.com/orgs/vercel/discussions/103
...
>
> 如果您的供应商不允许大型部署(chromium.br为50+MB)，您将需要单独托管Chrome-v#-Pack.tar 并使用
...
更多远程执行包，可以查看 https://github.com/Sparticuz/chromium/releases
...
部署成功后，访问 **Domains** 点击 **Blog screenshot** 链接，🤩 网页截图再次生成，可以看到，非常快！
