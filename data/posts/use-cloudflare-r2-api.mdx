...
> 本文转发并翻译至: [Building a Scalable & Affordable Image Hosting Pipeline with Cloudflare R2](https://dub.co/blog/image-hosting-r2 "{rel='nofollow'}")
...
- [Building a Scalable & Affordable Image Hosting Pipeline with Cloudflare R2](https://dub.co/blog/image-hosting-r2 "{rel='nofollow'}")
