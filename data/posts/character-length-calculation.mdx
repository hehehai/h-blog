...
我们这里暂时不讨论 [UTF-8](https://zh.wikipedia.org/wiki/UTF-8) 的处理，大部分引擎是支持 [UTF-16](https://zh.wikipedia.org/wiki/UTF-16) 编码的，也是我们日常字符问题的根本原因。

这里不介绍具体字符长度的计算问题如何产生的了，可以参考下面的文章。
...
或者，您可以使用正则表达式，var regexCodePoint = /[^\ud800-\udfff]|[\uD800-\uDBFF][\udc00-\udfff]|[\uD800-\uDFFF]/g;并遍历匹配项。
