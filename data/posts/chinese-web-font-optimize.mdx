...
![性能](/static/images/chinese-web-font-optimize/2024-01-11-170308.png)

![指标](/static/images/chinese-web-font-optimize/2024-01-11-170352.png)

![网址](/static/images/chinese-web-font-optimize/2024-01-11-170639.png)

## 直接引入

<div data-card="tip">
这里的字体是使用 woff2 这是对比其他网页字体类型更优的选择。
...
<div data-card="note">
SFNT (Scalable Font Format) 代表了多种字体格式，其中最常见的包括：
...
![小米字体](/static/images/chinese-web-font-optimize/misans-test.jpeg)

子集只有 `网页中文字体加载速度优化` 可以看到有区别的 😆，我们换 [优设 - 得意黑](https://uiiiuiii.com/software/573785.html) 来试试，这次的差异就很明显了。

![得意黑字体](/static/images/chinese-web-font-optimize/deyisans-test.jpeg)
...
![中文网字计划](/static/images/chinese-web-font-optimize/20240112102658.png)

![中文网字特点](/static/images/chinese-web-font-optimize/20240112102920.png)
...
![字体分包器](/static/images/chinese-web-font-optimize/20240112103423.png)
...
![切片](/static/images/chinese-web-font-optimize/20240112110149.png)
...
![性能](/static/images/chinese-web-font-optimize/2024-01-12-114015.png)

![指标](/static/images/chinese-web-font-optimize/20240112114108.png)

我使用 CDN 的方式，依然有优化空间。不过目前的效果已经非常好了 🥳

![CDN 指标](/static/images/chinese-web-font-optimize/20240112114214.png)
